...
using (var scope = app.Services.CreateScope())
{
    ...
    await db.Database.ExecuteSqlRawAsync("""
        ...
        """);
    await db.Database.ExecuteSqlRawAsync("CREATE INDEX IF NOT EXISTS \"IX_Friendships_AddresseeId\" ON \"Friendships\" (\"AddresseeId\");");
    await db.Database.ExecuteSqlRawAsync("CREATE UNIQUE INDEX IF NOT EXISTS \"IX_Friendships_RequesterId_AddresseeId\" ON \"Friendships\" (\"RequesterId\", \"AddresseeId\");");    await DbSeeder.SeedGenresAsync(db);
}
